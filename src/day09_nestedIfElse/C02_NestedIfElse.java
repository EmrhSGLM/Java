...
public class C02_NestedIfElse {
	...
	public static void main(String[] args) {
		...
		// iki alaný birþeþtiriyorsaniz veya ; tek alani birleþtiriyorsaniz ve kullanýlýr
		
		if (sayi<1000 || sayi>9999) { System.out.println("4 basamakli pozitif sayi girmelisiniz : ");
