...
public class C01_Contains {
	...
	public static void main(String[] args) {
		...
		int arr[] = {2,3,4,5,3,6,2,5,3,7,4,8,5,9,1,0,3,50};
		...
		System.out.println("tekrarsiz array sort'dan once : "+Arrays.toString(tekrarsizArray));
		Arrays.sort(tekrarsizArray);
		System.out.println("tekrarsiz array sort'dan sonra : "+Arrays.toString(tekrarsizArray));		
