...
public class C03_MethodOverloading {
	...
	public static void main(String[] args) {
		...
		// Java da ayni isimde birden fazla metod olur mu ?
		// cevap : evet
		
		// Ayni isim de birden fazla metod olursa Java hangisini calistiracagina nasil karar verir ?
		
		// isim ayni olan metodlarda oncelikle parametre sayisina bakar 
		// sonrada parametre sayisi ile arguman sayisi esit olanlardan 
		// arguman data turlari ile parametre data turlari arasinda uyuma bakar
		// tamamen uyusan varsa onu kullanir
		// tamamen uyusan yoksa kapsayan var mi bakar onu kullanir
