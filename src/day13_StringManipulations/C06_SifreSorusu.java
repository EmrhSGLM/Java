...
public class C06_SifreSorusu {
	...
	public static void main(String[] args) {
		...
		System.out.println("Lutfen 16 karakterli kredi karti numaranizi bosluk birakmadan yazin");
		String kkNo=scan.next();
		
		String isimFormatli=isim.substring(0, 1).toUpperCase()+ isim.substring(1).replaceAll("\\w", "*");
		String soyisimFormatli=soyisim.substring(0, 1).toUpperCase() + soyisim.replaceAll("\\w", "*");
