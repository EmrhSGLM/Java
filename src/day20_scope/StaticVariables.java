...
public class StaticVariables {
	...
	static int no=20;
	static int sayi;
	static String adtes="Ankara";
	static String cadde;
	static boolean aktifMi=true;
	static boolean tatildeMi;

	public static void main(String[] args) {
		// instance variable'lara main method'dan direk ulasilabilir mi ? Evet
	...
	public void staticOlmayanMethod( ) {
		// instance variable'lara main method'dan direk ulasilabilir mi ? Evet
		// static variable'lara static olan veya olmayan tum method'larda ulasilabilir
